...
- TradeManager (açma, kapatma, stake hesabı, PnL hesabı)
  * Stake: her işlem açılışında ANLIK olarak Bybit'ten bakiye okunur, %2 alınır.
    Açıldığı andaki stake Trade objesinde saklanır, PnL onun üzerinden hesaplanır.
...
class TradeManager:
    ...
    # ------------------------------------------------------------------
    # STAKE (her çağrıda ANLIK bakiyeden hesaplanır)
    # ------------------------------------------------------------------
    def get_stake(self):
        """
        Anlık stake: Bybit'ten güncel bakiyeyi çeker, stake_pct ile çarpar.
        Her işlem açılışında bu çağrılır.
        """
    ...
    def open_trade(self, symbol, side, thread, entry_price,
        ...
        Stake her açılışta ANLIK olarak bakiyeden %2 alınarak hesaplanır.
        ...
        # Stake: ANLIK bakiyeden %2 hesapla
        ...
        # Trade objesi (stake_usdt kaydediliyor — PnL hesabında bu kullanılacak)
        trade = Trade(
    ...
    def _finalize_close(self, trade, exit_name, close_price):
        ...
        # Açılış anındaki stake kullanılır (her işlemin kendi stake'i Trade'de saklı).
