...
- Sadece highest_level ilerlediğinde Telegram bildirimi atılır (tek yönlü).
- current_level içeride iki yönlü güncellenir.
...
class YellowThread(threading.Thread):
    ...
    def _tick_table(self, tbl):
        ...
        if tbl.active_trade and not tbl.active_trade.closed:
            ...
            # Seviye değişimi: current_level iki yönlü güncellenir,
            # bildirim SADECE highest_level ilerlediğinde atılır.
